...
public class PersistentIntervalMapTest {
    
    private PersistentIntervalMap<String> map = PersistentIntervalMap.empty();
    
    @Test
    public void emptyMap() {
        assertEquals(0, map.size());
        assertTrue(map.getOverlappers(42).isEmpty());
        assertTrue(map.getOverlappers(new Interval(-42, 42)).isEmpty());
    ...
    public void singleInterval() {
        map = map.with(new Interval(10, 20), "hello");
        
        assertEquals(1, map.size());
        assertTrue(map.getOverlappers(7).isEmpty());
        assertTrue(map.getOverlappers(27).isEmpty());
        assertTrue(map.getOverlappers(20).isEmpty());
    ...
    public void overlappersOfDisjointIntervals() {
        map = map.with(new Interval(10, 20), "10_20");
        map = map.with(new Interval(30, 40), "30_40");
        map = map.with(new Interval(50, 60), "50_60");
        map = map.with(new Interval(60, 70), "60_70");
    ...
    public void overlappersOfContinuousIntervals() {
        map = map.with(new Interval(10, 20), "10_20");
        map = map.with(new Interval(20, 30), "20_30");
        map = map.with(new Interval(30, 40), "30_40");
        map = map.with(new Interval(40, 50), "40_50");
    ...
    public void overlappersOfNestedIntervals() {
        map = map.with(new Interval(10, 60), "10_60");
        map = map.with(new Interval(20, 50), "20_50");
        map = map.with(new Interval(30, 40), "30_40");
    ...
    public void overlappersOfIntervalsWithSameBoundaries() {
        map = map.with(new Interval(10, 30), "10_30");
        map = map.with(new Interval(10, 50), "10_50");
        map = map.with(new Interval(30, 50), "30_50");
        map = map.with(new Interval(20, 40), "20_40");
        map = map.with(new Interval(10, 40), "10_40");
        map = map.with(new Interval(30, 50), "duplicate");
    ...
    public void triggerLeftRotate() {
        map = map.with(new Interval(110, 111), "11");
        map = map.with(new Interval(60, 66), "6");
        map = map.with(new Interval(140, 141), "14");
        map = map.with(new Interval(20, 22), "2");
        map = map.with(new Interval(80, 88), "8");
        map = map.with(new Interval(120, 122), "12");
        map = map.with(new Interval(160, 166), "16");
        map = map.with(new Interval(10, 11), "1");
        map = map.with(new Interval(40, 44), "4");
        map = map.with(new Interval(70, 85), "critical");
        map = map.with(new Interval(90, 99), "9");
        map = map.with(new Interval(130, 133), "13");
        map = map.with(new Interval(150, 151), "15");
        map = map.with(new Interval(170, 177), "17");
        map = map.with(new Interval(30, 33), "3");
        map = map.with(new Interval(50, 55), "5");
        map = map.with(new Interval(100, 101), "10");
        assertEquals(17, map.size());
        
        map = map.without(new Interval(60, 66), "6");
    ...
    public void overlappersOfLargeCollection() {
        ...
        for (int i = 0; i < intervals.size(); ++i) {
            map = map.with(intervals.get(i), String.valueOf(i));
        }
        ...
        for (int point = 0; point < startRange; point += 10) {
            ...
            Truth.assertThat(map.getOverlappers(point)).containsExactlyElementsIn(expected);
        }
    }
    ...
    public void overlappersOfLargeCollectionInterval() {
        ...
        for (int point = 0; point < startRange; point += 10) {
            ...
            Truth.assertThat(map.getOverlappers(test)).containsExactlyElementsIn(expected);
        }
    }
    ...
    public void removeSingleElement() {
        ...
        assertSame(map, map.without(new Interval(10, 20), "hi!"));
        assertSame(map, map.without(new Interval(10, 21), "hello"));
        map = map.without(new Interval(10, 20), "hello");
        assertEquals(0, map.size());
    ...
    public void removeFromDisjunct() {
        map = map.with(new Interval(10, 20), "x");
        map = map.with(new Interval(30, 40), "y");
        map = map.with(new Interval(50, 60), "z");
        
        map = map.without(new Interval(30, 40), "y");
        Truth.assertThat(map.getOverlappers(14)).containsExactly("x");
        Truth.assertThat(map.getOverlappers(24)).isEmpty();
        
        map = map.without(new Interval(10, 20), "x");
    ...
    public void removeFromNested() {
        ...
        map = map.without(new Interval(10, 60), "10_60");
        map = map.without(new Interval(30, 40), "30_40");
        
        assertSame(map, map.without(new Interval(22, 33), "ff"));
    ...
    public void removeLargeCollection() {
        ...
        for (int i = 0; i < intervals1.size(); ++i) {
            map = map.with(intervals1.get(i), "remove-me");
        }
        for (int i = 0; i < intervals2.size(); ++i) {
            map = map.with(intervals2.get(i), String.valueOf(i));
        }
        for (int i = 0; i < intervals1.size(); ++i) {
            map = map.without(intervals1.get(i), "remove-me");
        }
